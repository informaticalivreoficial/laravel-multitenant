...
@section('title', "Vincular Permissão ao perfil {$perfil->name}")

@section('content_header')
<div class="row mb-2">
    <div class="col-sm-6">
        <h1><i class="fas fa-search mr-2"></i> Vincular Permissão ao perfil {{$perfil->name}}</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">                    
            <li class="breadcrumb-item"><a href="{{route('home')}}">Painel de Controle</a></li>
            <li class="breadcrumb-item"><a href="{{route('perfis.permissoes',['idPerfil' => $perfil->id])}}">Permissões do perfil</a></li>
        ...
        <div class="card-body">
            ...
            @if(!empty($permissoes) && $permissoes->count() > 0)
                <table id="example1" class="table table-bordered table-striped projects">
                    ...
                    <tbody> 
                        <form action="{{route('perfis.permissoes.store',['idPerfil' => $perfil->id])}}" method="post">
                        @csrf
