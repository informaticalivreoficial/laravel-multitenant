...
@section('title', "Permissões do perfil {$perfil->name}")

@section('content_header')
<div class="row mb-2">
    <div class="col-sm-6">
        <h1><i class="fas fa-search mr-2"></i> Permissões do perfil {{$perfil->name}}</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">                    
            <li class="breadcrumb-item"><a href="{{route('home')}}">Painel de Controle</a></li>
            <li class="breadcrumb-item"><a href="{{route('perfis')}}">Perfis</a></li>
            <li class="breadcrumb-item active">Permissões do perfil {{$perfil->name}}</li>
        </ol>
    </div>
</div>
@stop
...
@section('content')
    <div class="card">
        <div class="card-header text-right">
            <a href="{{route('perfis.permissoes.create',['idPerfil' => $perfil->id])}}" class="btn btn-default"><i class="fas fa-plus mr-2"></i> Cadastrar Permissão</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <div class="row">
