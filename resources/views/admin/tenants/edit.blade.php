...
<form action="{{ route('tenant.update', $empresa->id) }}" method="post" enctype="multipart/form-data">
@csrf
@method('PUT')  
<div class="row">            
    <div class="col-12">
                                ...
                                <div class="row mb-2">
                                    <div class="col-12 col-md-6 col-lg-6"> 
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Empresa" name="name" value="{{ old('name') ?? $empresa->name }}">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-6"> 
                                        <div class="form-group">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6"> 
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control cnpjmask" placeholder="CNPJ da Empresa" name="cnpj" value="{{ old('cnpj') ?? $empresa->cnpj }}"/>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-6"> 
                                        <div class="form-group">
                                            <label class="labelforms text-muted"><b>Inscrição Estadual:</b></label>
                                            <input type="text" class="form-control" placeholder="Número da Inscrição" name="ie" value="{{ old('ie') ?? $empresa->ie }}"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
