...
@section('title', 'Cadastrar Template')
...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1><i class="fas fa-search mr-2"></i>Cadastrar novo Template</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Painel de Controle</a></li>
            <li class="breadcrumb-item"><a href="{{route('templates.index')}}">Templates</a></li>
            <li class="breadcrumb-item active">Cadastrar novo Template</li>
        </ol>
    </div>
</div> 
@stop
...
<form action="{{ route('templates.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
@csrf          
<div class="row">            
    <div class="col-12">
                       ...
                       <div class="row">
                            ...
                            <div class="col-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select name="exclusivo" class="form-control">
                                        <option value="1" {{ (old('exclusivo') == '1' ? 'selected' : '') }}>Sim</option>
                                        <option value="0" {{ (old('exclusivo') == '0' ? 'selected' : '') }}>Não</option>
                                    </select>
                                </div>
                            </div>
                       </div>
                        ...
                        <div class="row">  
                            ...
                            <div class="col-12">   
                                ...
                                <x-adminlte-text-editor name="content" v placeholder="Descrição do template..." :config="$config">{{ old('content') }}</x-adminlte-text-editor>                                                      
                            </div>
                        </div>                               
