                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="blog-3">
                            <div class="blog-image">
                                <a href="{{route(($type == 'artigo' ? 'web.blog.artigo' : 'web.noticia'),['slug' => $post->slug])}}">
                                    <img src="{{$post->cover()}}" alt="{{$post->titulo}}" class="img-fluid"> 
                                </a>                               
                            </div>
                            <div class="detail">
                                <h4>
                                    <a href="{{route(($type == 'artigo' ? 'web.blog.artigo' : 'web.noticia'),['slug' => $post->slug])}}">{{$post->titulo}}</a>
                                </h4>
                                {{--$post->content--}}
                                <a href="{{route(($type == 'artigo' ? 'web.blog.artigo' : 'web.noticia'),['slug' => $post->slug])}}" class="read-more">Ler Mais...</a>
                            </div>
                        </div>
                    </div>
                @endforeach
