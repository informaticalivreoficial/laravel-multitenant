            ...
            <div class="row py-4">
                    ...
                    <div class="main_property_content_structure">
                        ...
                        <div class="row">
                            ...
                            @if($imovel->balcaoamericano == true)
                                <span class="main_property_content_structure_item icon-check">Balcão Americano</span>
                            @endif
                            ...
                            @if($imovel->banheirosocial == true)
                                <span class="main_property_content_structure_item icon-check">Banheiro Social</span>
                            @endif

                            @if($imovel->bar == true)
                                <span class="main_property_content_structure_item icon-check">Bar Social</span>
                            @endif
                            ...
                            @if($imovel->brinquedoteca == true)
                                <span class="main_property_content_structure_item icon-check">Brinquedoteca</span>
                            @endif

                            @if($imovel->condominiofechado == true)
                                <span class="main_property_content_structure_item icon-check">Condomínio fechado</span>
                            @endif
                            ...
                            @if($imovel->geradoreletrico == true)
                                <span class="main_property_content_structure_item icon-check">Gerador elétrico</span>
                            @endif

                            @if($imovel->interfone == true)
                                <span class="main_property_content_structure_item icon-check">Interfone</span>
                            @endif

                            @if($imovel->jardim == true)
                                <span class="main_property_content_structure_item icon-check">Jardim</span>
                            @endif
                            ...
                            @if($imovel->pertodeescolas == true)
                                <span class="main_property_content_structure_item icon-check">Perto de Escolas</span>
                            @endif
                            ...
                            @if($imovel->quadrapoliesportiva == true)
                                <span class="main_property_content_structure_item icon-check">Quadra poliesportiva</span>
                            @endif
                            ...
                            @if($imovel->saladetv == true)
                                <span class="main_property_content_structure_item icon-check">Sala de TV</span>
                            @endif

                            @if($imovel->salaodefestas == true)
                                <span class="main_property_content_structure_item icon-check">Salão de Festas</span>
                            @endif

                            @if($imovel->salaodejogos == true)
                                <span class="main_property_content_structure_item icon-check">Salão de Jogos</span>
                            @endif
                            ...
                            @if($imovel->sistemadealarme == true)
                                <span class="main_property_content_structure_item icon-check">Sistema de alarme</span>
                            @endif

                            @if($imovel->permiteanimais == true)
                                <span class="main_property_content_structure_item icon-check">Permite animais</span>
                            @endif

                            @if($imovel->varandagourmet == true)
                                <span class="main_property_content_structure_item icon-check">Varanda Gourmet</span>
                            @endif
                ...
                <div class="col-12 col-lg-4">
                    ...
                    <div class="main_property_contact">
                        ...
                        <form action="action" method="post" class="j_formsubmit" autocomplete="off">  
                            @csrf
                    ...
                    <div class="main_property_share mt-3">
                        ...
                        <p> 
                            @if(!empty($tenant->telefone))
                                <i class="icon-phone text-front"></i> <a href="tel:55+ {{$tenant->telefone}}" class="text-front">{{$tenant->telefone}}</a>
                            @endif                            
                            @if(!empty($tenant->celular))
                                <i class="icon-phone text-front"></i> <a href="tel:55+ {{$tenant->celular}}" class="text-front">{{$tenant->celular}}</a>
                            @endif 
                        </p>
                        <p>
