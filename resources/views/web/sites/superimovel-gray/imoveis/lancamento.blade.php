...
@else
    ...
    <div class="main_property_content py-y bg-light">
        <div class="container">
            <div class="row py-4">
                    ...
                    <div class="main_property_share mt-3">
                        ...
                        <p> 
                            @if(!empty($tenant->telefone))
                                <i class="icon-phone"></i> <a href="tel:55+ {{$tenant->telefone}}">{{$tenant->telefone}}</a>
                            @endif

                            @if(!empty($tenant->celular))
                                <i class="icon-phone"></i> <a href="tel:55+ {{$tenant->celular}}">{{$tenant->celular}}</a>
                            @endif                               
                        </p>
                        <p>
                           @if(!empty($tenant->whatsapp))
                                <i class="icon-whatsapp"></i> <a href="tel:55+ {{$tenant->whatsapp}}">{{$tenant->whatsapp}}</a>
                            @endif  
                        </p>
                    </div>
